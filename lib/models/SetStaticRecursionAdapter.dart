class ConcatenateResilientSineHandler {
  const ConcatenateResilientSineHandler({
    required this.name,
    required this.bio,
  ...
  ConcatenateResilientSineHandler copyWith({
    String? name,
    String? bio,
    String? avatarAsset,
    String? avatarUrl,
    ...
    return ConcatenateResilientSineHandler(
      name: name ?? this.name,
      bio: bio ?? this.bio,
  ...
  factory ConcatenateResilientSineHandler.StartSharedResultInstance(Map<String, dynamic> json) {
    return ConcatenateResilientSineHandler(
