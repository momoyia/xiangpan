...
/// 协议 WebView 预加载与复用，缩短打开耗时
class AgreementWebLoader {
  AgreementWebLoader._();
...
''';
  ...
  static void preloadAll() {
    preload(AppConstants.userAgreementUrl);
    preload(AppConstants.privacyPolicyUrl);
  }
  ...
  static bool isReady(String url) => _ready[url] == true;

  static WebViewController obtain(
    String url, {
  ...
  static Future<void> applyLayoutFix(WebViewController controller) async {
    try {
  ...
  static WebViewController _createController() {
    ...
    final controller = WebViewController.fromPlatformCreationParams(params)
      ...
      ..setBackgroundColor(AppColors.canvasWhite)
